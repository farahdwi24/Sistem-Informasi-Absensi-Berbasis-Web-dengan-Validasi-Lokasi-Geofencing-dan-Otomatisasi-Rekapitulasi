                        ...
                        <div class="card z-index-0 fadeIn3 fadeInBottom">
                            ...
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-custom-purple-solid shadow-primary border-radius-lg py-3 pe-1 text-center">
                                    <h3 class="text-white font-weight-bolder mt-2 mb-0">KONFIRMASI PASSWORD</h3>
                                </div>
                            </div>
                            
                            <div class="card-body">
                                <p class="mb-3 text-center text-sm">
                                    {{ __('Ini adalah area aman. Mohon konfirmasi password Anda saat ini sebelum melanjutkan.') }}
                                </p>
